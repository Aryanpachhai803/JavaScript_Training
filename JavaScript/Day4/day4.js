...
console.log('100' - 60); //40 (In this case, with the intillegence of JS other opreator shows normal calculation  but in '+' operator it will add the string and number)
